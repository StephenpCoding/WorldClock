...
const StyledPointer = styled.div`
  ...
  color: ${props => props.$light ? props.$white : props.$black};
`
...
StyledPointer.defaultProps = {
  ...
  $bg_white_box_shadow:
    "inset 0 0 30px rgba(0, 0, 0, 0.1), 0 20px 20px rgba(0, 0, 0, 0.2), 0 0 4px rgba(255, 255, 255, 1)",
  $bg_black_box_shadow:
    "inset 0 0 30px rgba(255, 255, 255, 0.1), 0 20px 20px rgba(0, 0, 0, 0.5), 0 0 4px #091921",
}
